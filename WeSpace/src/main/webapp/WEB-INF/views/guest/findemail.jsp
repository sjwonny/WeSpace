...
<%@ include file="/WEB-INF/views/layout/header.jsp" %>
	...
	<h2>Find Email</h2>
        <form method="post" action="${ pageContext.request.contextPath }/guest/find" id="find-form" name="findEmail" onsubmit="return check(this)">
        <input type="hidden" name="mode" value="guest_email"> 
	...
	<div class="helper_utill">
		<ul class="helper_list">
			...
			<a id="findBtn" href="${ pageContext.request.contextPath }/guest/findpw" 
