...
<%@ include file="/WEB-INF/views/layout/header.jsp" %>
    <div class="find-wrapper">
        <h2>Find Pw</h2>
        <form method="post" action="${ pageContext.request.contextPath }/host/find" id="find-form" name="findPw" onsubmit="return check(this)">
        <input type="hidden" name="mode" value="host_pw"> 
        <input type="text" id = "host_email" name="host_email" placeholder="이메일">
	...
	<div class="helper_utill">
		<ul class="helper_list">
			...
			<a id="findBtn" href="${ pageContext.request.contextPath }/host/findemail" 
